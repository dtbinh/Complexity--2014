...
%
We do not make\alert{should this be assume instead of make} any knowledge of the generating process or its
...
\alert{With all the extra material above, the following paragraph now
