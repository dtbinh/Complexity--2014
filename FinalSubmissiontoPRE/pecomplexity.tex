...
\begin{figure}[t]
    ...
    \caption{(Color online) An IPC trace during the execution of \gcc.  The colors (also separated by vertical dashed lines)
...
$\sim$21,000 (in units of $10^5$ instructions) measurements,
...
color-coded in the figure (as well as separated by vertical dashed lines) in order to make textual cross-references
easy to track.
...
determined visually, are shown in different colors (also separated by vertical dashed lines) in
...
\svdone---the dark blue (first) segment of
