...
\cite{henon}, the Lorenz system \cite{lorenz}, the SFI A data set\footnote{\alert{This dataset can be retrieved from \url{http://www-psych.stanford.edu/~andreas/Time-Series/SantaFe.html}.}}
\cite{weigend-book,sfi-data},\alert{maybe make the website a footnote instead} and a random-walk process all fall
within the one-$\sigma$ volume of the fit in
Figures~\ref{fig:wpe_vs_mase_best} and~\ref{fig:wpe_vs_mase_all}
region, as do various nonlinear transformations of \svdtwo, \svdfive
and \svdsix.
