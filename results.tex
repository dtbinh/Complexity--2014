...
work along those lines shows that data from the Henon map
\cite{henon}, the Lorenz system \cite{lorenz}, the SFI A data set
\cite{weigend-book,sfi-data}, and a white-noise process all fall
