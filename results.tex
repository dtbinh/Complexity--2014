...
outliers in the blue cluster of $+$ points in the bottom-left panel of
Figure~\ref{fig:what}) had much higher \arima MASE values, indicating
a failure in the \arima process.  We then went back and manually
assisted the automated fitting procedure---forcing inclusion of a term
that is appropriate for a nonstationary signal.  In all cases, this
produced ARIMA models with MASE scores in line with the others in that
cluster.
