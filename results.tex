...
\caption{WPE vs. $MASE$ for all trials, methods, and systems. \svdone,
  ...
  reasons. {\color{red} All three plots need to have the same
    horizontal scale!}
% 
...
{\color{red}[[We need to come up with a hypothesis about this spread,
      even if it's totally tentative.  Was it that the random-walk got
      really good in a few of the \col trials?  Or that ARIMA got
      really bad in those trials?  In either case, why did that
      happen---what was it about those trials that made ARIMA bark
      and/or random walk do well?]]} The position of the LMA
cluster---well to the left of the other two, near the dashed
line---reflects this method's ability to capture and exploit the
structure that is present in this signal.

The WPE of \svdfive ($0.677 \pm 0.006$) is higher than that of {\tt
  col\_major}.  This indicates that the rate{\color{red} is this really a rate} of forward information
