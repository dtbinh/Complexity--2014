...
the scalar observation $X_{i,obs}$ at time $i$ was a measurement of
how well each program was able to exploit the native parellelism of
the i7 chip.  To record these measurements, we used the {\tt libpfm4}
library, via PAPI
% 
