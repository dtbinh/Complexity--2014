...
{\color{red}Joshua, can you please insert code here?} 
...
series of the processor performance during the execution this program
is shown in Figure~\ref{fig:col-ts}. \alert{would it be useful to
  include said 3-line loop?}
\begin{figure}[htbp]
  \centering
