...
by taking the cumulative sum of $\mu=0$, $\sigma=1$ \alert{[[generated
      how?  Gaussian random variables,]]} and data set ``A'' from the
Santa Fe Institute time-series competition website.
