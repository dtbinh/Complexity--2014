...
As we stated in Section \ref{sec:intro} we intend to show two primary contributions of this work: 

[[Joshua: Probably need to rephrase these]]
\begin{enumerate}
...
\end{enumerate}
 ...
 In this section we will validate these two key findings.
