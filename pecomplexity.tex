...
% also called permutation complexity
...
% It has been shown [amigo?] that the
% normalized permutation entropy \ref{eq:permEntropy} is equal to the
% Kolmogorov-Sinai entropy and therefore is a proxy for the rate at
% which a system becomes unpredictable.




% This spectrum is outlined very nicely in \cite{amigo2012permutation}:
% ``Periodic or quasiperiodic sequences have vanishing or negligible
% complexity. At the opposite end, independent and identically
% distributed random sequences (white noise) have asymptotically
% divergent permutation entropies, owing to the fact that the number of
% allowed (or ``admissible'') ordinal patterns grows superexponentially
% with length. Between both ends lie the kind of sequences we are
% interested in.''
...
% Tables~\ref{tab:TCMpe} \& \ref{tab:IPCpe}
...
\begin{table}[htdp]
\caption{Average nRMSE over 15 runs for each signal and average (?) pe [[Ryan:is this average over all 15 and is this weighted]] at word length 5 and 6 for each signal. }
\begin{center}
\begin{tabular}{|c|c|c|c|c|c|}
\hline
& Horizon&nRMSE LMA & nRMSE mean & $l=5$& $l=6$\\
\hline
gcc &4542&  $0.1407\pm0.0063 $   & $0.1487\pm0.0066$ & - & - \\
col\_major &14,709&  $0.0252\pm0.0061$   & $0.1975\pm0.0436$ & - & -\\
 
SVD\_Full &22,072&  $0.0323\pm0.0019$  & $ 0.1784\pm0.0040$ & - & -  \\
SVD\_IPC\_Regime1 &2,158&  $0.1680 \pm 0.0317$  & $0.3517\pm0.5223$ &0.9786 &0.9675  \\
SVD\_IPC\_Regime2 &6,902& $0.1716 \pm0.0043 $  &$0.1762 \pm0.0012$ &0.8800&0.8493 \\
SVD\_IPC\_Regime3 &947& $0.0507 \pm 0.0011$   &$0.5413\pm0.0005$  &0.7646&0.7029\\
SVD\_IPC\_Regime4 &2,929&  $0.1288\pm0.0471$  & $0.2308\pm0.0867$ &0.8735&0.7770\\
SVD\_IPC\_Regime5 &3,255&  $0.0235\pm0.0022$ & $0.1306\pm0.0003$&0.7281&0.6724 \\
SVD\_IPC\_Regime6 &5,804&  $0.0196\pm0.0022$  & $0.0508\pm0.0003$ &0.8316&0.7615 \\
\hline
\end{tabular}
\end{center}
\label{default}
