...
\begin{figure}[htbp]
  ...
  %  \includegraphics[width=1.0\textwidth]{figs/LMA_vs_ARIMA}
   \caption{[[move this to after the 3 forecast have been described and add the same plot for mean prediction]] 
...
Include traces of full \col and \gcc
...
\subsection{LMA}
\subsection{ARIMA}
\subsection{Naive: Random Walk and mean}
