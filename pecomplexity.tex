...
\alert{This paper provides insight into when, why, and how forecast
  strategies fail when they are applied to complicated time series.}
We conjecture that the inherent complexity of real-world time-series
