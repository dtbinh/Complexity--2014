...
% [[if anyone asks us to derive a figure of merit for the model:
% 
% https://www.researchgate.net/post/How_to_assess_goodness_of_fit_for_a_non-linear_model
% 
% BMC Pharmacol. 2010; 10: 6. doi: 10.1186/1471-2210-10-6 ``An
% evaluation of R2 as an inadequate measure for nonlinear models in
% pharmacological and biochemical research: a Monte Carlo approach''
% 
% Researchers and reviewers should be aware that R2 is inappropriate
% when used for demonstrating the performance or validity of a certain
% nonlinear model. It should ideally be removed from scientific
% literature dealing with nonlinear model fitting or at least be
% supplemented with other methods such as AIC or BIC or used in context
% to other models in question.
