...
measurement issues like noise, aggregation, and finite data length ---
is both empirically quantifiable and directly correlated with
predictability. To validate this conjecture, we study 120 different
time-series data sets.  We argue that \emph{redundancy} is an
effective way to measure complexity and predictive structure in a time
series and that \emph{weighted permutation entropy} is an effective
way to estimate that complexity.  For each time series, we construct
