...
time-series data sets and a wide variety of forecast models. We
estimate the complexity of each time series using a variant of
permutation entropy, then compare that complexity with the accuracy of
each forecast method.  We use the results to develop a heuristic that
can help practitioners recognize when a particular prediction method
is not well matched to the task at hand: that is, when the time series
