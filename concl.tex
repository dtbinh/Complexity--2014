...
intermittent instability or traffic at an internet router, which has
characteristic patterns during normal operation that shift radically
during an attack.  Effective modeling and prediction of these kinds of
systems effectively is quite difficult; doing so adaptively and
