...
more than $3.5788 \cdot \mathrm{WPE} - 1.909$, where WPE is that of
the corresponding signal, is an indication that that time series has
more predictive structure than that forecast model can capture and
exploit.
