...
forecast is guaranteed to converge to the\alert{ mean, a constant, or a linear trend}, after some number of
predictions, depending on model order.  To sidestep this issue, we
build forecasts in a stepwise fashion: i.e., fit the \arima model
