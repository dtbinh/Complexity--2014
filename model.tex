...
in the embedded\footnote{Lorenz's original formulation used the full
  system state space; According to \cite{kantz97} this method was
  first extended to embedded dynamics by Pikovsky
  ~\cite{pikovsky86-sov}, but more closely related to the prediction
  work of Sugihara \& May in \cite{sugihara90}}
